app.controller("authority-ctrl", function($scope, $http, $location) {
  ...
  $scope.initialize = function() {
    ...
    // load authorities of staffs and directors [ tải các quyền được cấp của các admin]
  ...
  $scope.grant_authority = function(authority) {
    $http.post(`/rest/authorities`, authority).then(resp => {
      $scope.authorities.push(resp.data); // sau khi save vào csdl. Bổ sung data vào authorities để hiển thị lên view
